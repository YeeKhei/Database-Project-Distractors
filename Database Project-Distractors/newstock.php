...
<center><h2>Add New Stock<h2>
</center>
<form action="insertnewstock.php"method="POST">
Product ID:
<input type="text"name="Product_ID"required="required"/></br></br>
Product Name:<input type="text"name="Product_Name"required="required"/></br></br>
Category ID:<input type="text"name="Category_ID"required="required"/></br></br>
Product Price:<input type="text"name="Product_Price"required="required"maxlength="50"/>
</br></br>
Product Supplier ID:
<input type="text"name="Product_Supplier"required="required"maxlength="50"/></br></br>
Stock:<input type="number"name="Stock"required="required"/></br></br>
