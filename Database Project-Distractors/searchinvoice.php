...
$search=$_POST['search'];
$query = $pdo->prepare("SELECT *FROM ordering WHERE Date LIKE '%$search%' OR Invoice_No LIKE '%$search%' OR Product_ID LIKE '%$search%' OR Supplier_ID LIKE '%$search%'  LIMIT 0 , 10");
...
// Display search result
         if (!$query->rowCount() == 0) {
				...
				<td style=\"border-style:solid;border-width:1px;border-color:#98bf21;background:#98bf21;\">Invoice No</td>
            ...
            while ($results = $query->fetch()) {
				...
				echo $results['Invoice_No'];
				echo "</td><td style=\"border-style:solid;border-width:1px;border-color:#98bf21;\">";
                echo $results['Product_ID'];
				echo "</td><td style=\"border-style:solid;border-width:1px;border-color:#98bf21;\">";
                echo $results['quantity'];
				echo "</td><td style=\"border-style:solid;border-width:1px;border-color:#98bf21;\">";
                echo $results['Supplier_ID'];
				echo "</td><td style=\"border-style:solid;border-width:1px;border-color:#98bf21;\">";
                echo $results['Product_Price'];
				echo "</td><td style=\"border-style:solid;border-width:1px;border-color:#98bf21;\">";
                echo $results['Total_Price'];
				echo "</td></tr>";				
            }
				echo "</table>";		
        } else {
